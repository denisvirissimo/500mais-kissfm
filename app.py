...
with col2:
    ...
    tab_geral, tab_edicao, tab_edicoes, tab_musicas, tab_artistas, tab_analises, tab_curiosidades, tab_predicoes = st.tabs(["Visão Geral", "Por Edição", "Todas as Edições", "Músicas", "Artistas", "Análises", "Curiosidades", "Predições"])
